...
export const BREAD_URL = "https://www.miden.xyz/wallet";
...
export const MARKETS = [
  { id: "0x8eddfd14bf6626913cb31a58428793", label: "Oct 20, 2026", question: "Will Miden Partner Mainnet be announced before Oct 20, 2026?", deadlineMs: Date.parse("2026-10-20T00:00:00Z") },
  { id: "0x1d20145e5360cfd10671e1f093e97c", label: "Oct 28, 2026", question: "Will Miden Partner Mainnet be announced before Oct 28, 2026?", deadlineMs: Date.parse("2026-10-28T00:00:00Z") },
  { id: "0xfb13ce79ff4bb7d1310de3bc1c8d3b", label: "Nov 5, 2026", question: "Will Miden Partner Mainnet be announced before Nov 5, 2026?", deadlineMs: Date.parse("2026-11-05T00:00:00Z") },
];
export const MARKETS_URL = "/markets.json";
/** Operator server (admin view only; localhost). */
export const ADMIN_URL = "http://127.0.0.1:5181";
/** The operator opens waiting notes at every 10-minute mark. */
