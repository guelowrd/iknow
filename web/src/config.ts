...
export const QUESTION = "PARTNER MAINNET STARTS NOW";
export const X_ACCOUNT = "@0xMiden";

export const MARKETS = [
  { id: "0x8eddfd14bf6626913cb31a58428793", label: "OCT 20", deadlineMs: Date.parse("2026-10-20T00:00:00Z") },
  { id: "0x1d20145e5360cfd10671e1f093e97c", label: "OCT 28", deadlineMs: Date.parse("2026-10-28T00:00:00Z") },
  { id: "0xfb13ce79ff4bb7d1310de3bc1c8d3b", label: "NOV 5", deadlineMs: Date.parse("2026-11-05T00:00:00Z") },
] as const;
